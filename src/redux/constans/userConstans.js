...
export const USER_VERIFICATION_EMAIL_REQUEST =
  'USER_VERIFICATION_EMAIL_REQUEST';
export const USER_VERIFICATION_EMAIL_FAILED = 'USER_VERIFICATION_EMAIL_FAILED';
export const USER_VERIFICATION_EMAIL_SUCCESS =
